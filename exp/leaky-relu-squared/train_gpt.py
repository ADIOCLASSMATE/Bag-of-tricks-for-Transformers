"""
Naive architecture GPT with strong training recipe + leaky-relu-squared trick.
...
Trick: leaky_relu(x, 0.5).square() replaces GELU activation in the MLP.
...
class MLP(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        # trick: leaky_relu(x, 0.5).square() replaces gelu
