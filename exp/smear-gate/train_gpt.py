...
class GPT(nn.Module):
    ...
    def forward(self, input_ids: Tensor, target_ids: Tensor) -> Tensor:
        ...
        # trick: smear-gate — source-faithful parameter-golf variant with per-dimension near-identity gate
...
def main() -> None:
    ...
    # trick: smear-gate — top-level gate is outside blocks, so add it explicitly
