"""
Naive architecture GPT with strong training recipe + residual-lambda-init-11 trick.
...
Trick: residual-lambda-init-11 — add learnable resid_mix parameters initialized to
residual=1.1, x0=0.1 per channel, matching the slowrun tiny initialization.
...
# residual-lambda-init-11 uses non-empty CONTROL_TENSOR_NAME_PATTERNS default to keep
...
# -----------------------------
# TRANSFORMER MODULES (custom Block + GPT for residual-lambda-init-11)
# -----------------------------
...
class Block(nn.Module):
    def __init__(
        ...
        # trick: residual-lambda-init-11 — match slowrun tiny: residual=1.1, x0=0.1
