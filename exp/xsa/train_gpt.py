"""
GPT with XSA (Exclusive Self-Attention) trick.

trick: xsa — Subtract the self-value projection from attention output:
  y_xsa = y - proj_{v_norm}(y)
Effectively removes the component of attention output aligned with the value
direction, improving model expressiveness. GQA-aware implementation.

Official implementation from parameter-golf A06/A07 (XSA4/XSA-all).
...
class CausalSelfAttention(nn.Module):
    ...
    # trick: xsa — GQA-aware exclusive self-attention
