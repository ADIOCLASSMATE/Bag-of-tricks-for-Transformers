...
ENV_KEY_MAP = {
    ...
    "engram_heads_per_ngram": "ENGRAM_HEADS_PER_NGRAM",
    "engram_embed_per_ngram": "ENGRAM_EMBED_PER_NGRAM",
    "engram_embed_dim": "ENGRAM_EMBED_DIM",
    "engram_vocab_multiplier": "ENGRAM_VOCAB_MULTIPLIER",
    "engram_vocab_sizes": "ENGRAM_VOCAB_SIZES",
    "engram_kernel_size": "ENGRAM_KERNEL_SIZE",
    "engram_pad_id": "ENGRAM_PAD_ID",
    "engram_use_tokenizer_compression": "ENGRAM_USE_TOKENIZER_COMPRESSION",
    "engram_warmup_steps": "ENGRAM_WARMUP_STEPS",
    "engram_soft_constraint_steps": "ENGRAM_SOFT_CONSTRAINT_STEPS",
    "engram_soft_constraint_min": "ENGRAM_SOFT_CONSTRAINT_MIN",
    "engram_embed_lr": "ENGRAM_EMBED_LR",
