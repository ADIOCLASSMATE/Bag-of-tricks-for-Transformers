"""
Naive architecture GPT with strong training recipe + untied embeddings trick.
...
class Hyperparameters:
    ...
    tie_embeddings = bool(int(os.environ.get("TIE_EMBEDDINGS", "1")))  # tied control for ablation
