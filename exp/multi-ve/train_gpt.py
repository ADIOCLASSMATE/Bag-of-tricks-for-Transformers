...
def main() -> None:
    ...
    optimizer_tok = torch.optim.AdamW(
        [{"params": [base_model.tok_emb.weight, base_model.ve_shallow.weight, base_model.ve_deep.weight], "lr": token_lr, "base_lr": token_lr, "weight_decay": args.weight_decay if args.tie_embeddings else 0.0}],
