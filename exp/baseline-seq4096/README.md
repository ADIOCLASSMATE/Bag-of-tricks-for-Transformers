# Baseline SEQ4096 — Sequence Length Ablation (4096)

## Method

This experiment is a **sequence length ablation** that increases `train_seq_len` from the baseline's 1024 to **4096**, while keeping all other hyperparameters (model architecture, optimizer, learning rates, `train_batch_tokens`, tokenizer, data) identical to `baseline-sp1024`.
...
| Parameter | baseline-sp1024 | baseline-seq4096 |
|---|---|---|
...
| Metric | baseline-sp1024 | baseline-seq2048 | baseline-seq4096 | Δ (4096 vs 1024) |
|---|---|---|---|---|
...
- `baseline-seq4096.json`: Experiment manifest
