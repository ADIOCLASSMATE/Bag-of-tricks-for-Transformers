...
echo "=== Running attention-residuals experiments (9 blocks, 2 controls) ==="
uv run python exp/run_experiments.py exp/attention-residuals/attention-residuals-4gpu.json
