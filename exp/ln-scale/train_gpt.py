...
class Block(nn.Module):
    def __init__(
        ...
        rope_base: float,
        qk_gain_init: float,
        layer_idx: int = 0,  # trick: ln-scale — pass layer index for depth-dependent scaling
    ):
        super().__init__()
        # trick: ln-scale — suppress deep-layer activation magnitude by 1/sqrt(layer_idx+1)
    ...
    def forward(self, x: Tensor, x0: Tensor) -> Tensor:
        ...
        # trick: ln-scale — multiply norm outputs by 1/sqrt(layer_idx+1)
        ...
        self.blocks = nn.ModuleList(
            [
                Block(
                    ...
                    rope_base,
                    qk_gain_init,
                    layer_idx=i,  # trick: ln-scale — pass layer index
                )
