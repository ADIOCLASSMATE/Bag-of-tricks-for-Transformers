...
Training recipe (identical to baseline):
  - Muon optimizer for 2D matrix params in the (shared) transformer blocks
...
Note: this variant has roughly 1/num_loop_repeats the unique transformer params of baseline.
It is included as a small exploratory experiment, not as a parameter-matched ablation.
"""
...
# -----------------------------
# TRANSFORMER MODULES (custom GPT for loop-share-all)
# -----------------------------
