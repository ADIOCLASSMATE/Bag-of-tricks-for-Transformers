"""
trick: loop-pure — Pure looped transformer: N shared blocks repeated M times with weight sharing
...
class GPT(nn.Module):
    def __init__(
        ...
        # trick: loop-pure — shared blocks repeated, no U-Net skip connections
...
def main() -> None:
    ...
    log0(f"trick:loop-pure loop_layers:{args.num_loop_layers} loop_repeats:{args.num_loop_repeats} effective_depth:{args.num_loop_layers * args.num_loop_repeats}")
